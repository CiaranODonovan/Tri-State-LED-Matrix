...
const char text[] = "CIARANS MATRIX   ";  // The text we want to scroll (left in ram for dynamic input controls; to be added later.)
...
void loop() {
    ...
    // Render the text with the current offset
